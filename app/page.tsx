...
import SalaryIllustration from '@/components/illustrations/SalaryIllustration';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-white max-w-xl">
            <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-4 py-1.5 mb-6">
              <TrendingUp size={16} />
              <span className="text-sm font-semibold">2026 Salary Data</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ fontFamily: 'Manrope, sans-serif' }}>
              What Should a Civil Engineer Earn in 2026?
            </h2>
          ...
          <div className="rounded-2xl overflow-hidden w-full max-w-sm" style={{ height: '290px' }}>
            <SalaryIllustration />
          </div>
        </div>
      </section>
