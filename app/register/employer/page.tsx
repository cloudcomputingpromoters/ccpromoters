    ...
    return (
      <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-[#E5E5E5] p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-[#0D0D0D] mb-2">Verify Your Email</h2>
          <p className="text-[#6B6B6B] mb-6">We sent a 6-digit code to <strong>{form.email}</strong></p>
    ...
    <div className="min-h-screen bg-[#F5F5F5] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0D0D0D] mt-4">Register as an Employer</h1>
          <p className="text-[#6B6B6B] mt-1">Start hiring pre-screened civil engineers today</p>
        </div>

        <div className="bg-white rounded-2xl border border-[#E5E5E5] p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            <h2 className="text-lg font-bold text-[#0D0D0D] pb-3 border-b border-[#E5E5E5]">Company Information</h2>
            ...
            <h2 className="text-lg font-bold text-[#0D0D0D] pt-2 pb-3 border-b border-[#E5E5E5]">Contact Person</h2>
            <div className="grid grid-cols-2 gap-4">
            ...
            <h2 className="text-lg font-bold text-[#0D0D0D] pt-2 pb-3 border-b border-[#E5E5E5]">Create Password</h2>
            <div>
            ...
            <div className="pt-2">
              <button type="submit" disabled={loading}
                className="w-full bg-[#CC1016] text-white font-bold py-4 rounded-lg hover:bg-[#A80D12] transition-colors disabled:opacity-70 text-base">
                {loading ? 'Creating Account...' : 'Create Employer Account →'}
              </button>
            </div>
            <p className="text-xs text-[#6B6B6B] text-center">
              By registering, you agree to our{' '}
              <Link href="/terms-of-service" className="text-[#CC1016] hover:underline">Terms</Link> and{' '}
        ...
        <p className="text-center text-sm text-[#6B6B6B] mt-6">
          Looking for a job?{' '}
          <Link href="/register/candidate" className="text-[#CC1016] font-semibold hover:underline">Register as a Candidate →</Link>
        </p>
      </div>
    </div>
  );
