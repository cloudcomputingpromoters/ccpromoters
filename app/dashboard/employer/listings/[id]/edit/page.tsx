      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-white rounded-2xl border border-[#E5E5E5] p-6 space-y-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-[#0D0D0D] mb-1.5">Job Title</label>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-[#0D0D0D] mb-1.5">Status</label>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-sm text-[#0D0D0D] font-medium">Remote position</span>
            </label>
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
          ...
          <div className="bg-white rounded-2xl border border-[#E5E5E5] p-6 space-y-4">
            <h3 className="font-bold text-[#0D0D0D]">Description</h3>
            {[
