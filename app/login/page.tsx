      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-[#0B1F3A] font-bold text-xl" style={{ fontFamily: 'Manrope, sans-serif' }}>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0] p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button onClick={() => handleOAuth('google')}
              className="flex items-center justify-center gap-2 border border-[#E2E8F0] rounded-lg py-3 text-sm font-medium text-[#0B1F3A] hover:border-[#E91E8C] hover:bg-pink-50 transition-all">
            ...
            <button onClick={() => handleOAuth('github')}
              className="flex items-center justify-center gap-2 border border-[#E2E8F0] rounded-lg py-3 text-sm font-medium text-[#0B1F3A] hover:border-[#E91E8C] hover:bg-pink-50 transition-all">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="#0B1F3A">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} required value={password} onChange={e => setPassword(e.target.value)}
                  ...
                  className="w-full border border-[#E2E8F0] rounded-lg px-4 py-3 pr-10 text-sm outline-none focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C] transition-colors" />
              ...
              <div className="text-right mt-1">
                <Link href="/forgot-password" className="text-xs text-[#E91E8C] hover:underline">Forgot Password?</Link>
              </div>
            </div>
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-[#E91E8C] text-white font-bold py-3.5 rounded-lg hover:bg-[#C0176E] transition-colors flex items-center justify-center gap-2 disabled:opacity-70">
          ...
          <p className="text-center text-sm text-[#4A5568] mt-6">
            ...
            <Link href="/register" className="text-[#E91E8C] font-semibold hover:underline">Register Free →</Link>
          </p>
        </div>
      </div>
    </div>
