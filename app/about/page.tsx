...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-r from-[#1A3A8F] to-[#163298] py-24 px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-[#D4AF37]" style={{ transform: 'translate(30%, -30%)' }} />
        </div>
        <div className="relative max-w-4xl mx-auto text-center">
          <span className="inline-block bg-[#D4AF37]/20 text-[#D4AF37] text-sm font-semibold px-4 py-1.5 rounded-full mb-4">About CCPromoters</span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: 'Manrope, sans-serif' }}>
            Built by Engineers, <span className="text-[#D4AF37]">for Engineers</span>
          </h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#1A3A8F] mb-6" style={{ fontFamily: 'Manrope, sans-serif' }}>Our Mission</h2>
          ...
          <div className="flex flex-col gap-4">
            {/* Site photo */}
            <div className="rounded-2xl overflow-hidden border border-[#E2E8F0]" style={{ height: '280px' }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={stat.label} className="bg-[#F7F9FC] rounded-xl p-4 border border-[#E2E8F0] text-center">
                  <div className="text-2xl font-extrabold text-[#D4AF37] mb-1" style={{ fontFamily: 'Manrope, sans-serif' }}>{stat.number}</div>
                  <div className="text-[#4A5568] text-xs font-medium">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-[#F7F9FC]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1A3A8F]" style={{ fontFamily: 'Manrope, sans-serif' }}>Our Approach</h2>
            <p className="text-[#4A5568] mt-3 max-w-xl mx-auto">Three principles that separate us from generalist staffing firms.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="bg-white rounded-2xl p-8 border border-[#E2E8F0] hover:shadow-lg transition-shadow">
                <div className="w-12 h-12 bg-[#D4AF37] text-white rounded-xl flex items-center justify-center mb-5">{item.icon}</div>
                <h3 className="font-bold text-[#1A3A8F] text-xl mb-3">{item.title}</h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="w-12 h-12 bg-[#1A3A8F] text-white rounded-xl flex items-center justify-center mb-5"><Users size={24} /></div>
            <h2 className="text-3xl font-bold text-[#1A3A8F] mb-4" style={{ fontFamily: 'Manrope, sans-serif' }}>Our Commitment to Diversity & Inclusion</h2>
            <p className="text-[#4A5568] leading-relaxed mb-4">
          ...
          <div className="bg-gradient-to-br from-[#1A3A8F] to-[#163298] rounded-2xl p-8 text-white">
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-3 mb-4 last:mb-0">
                <div className="w-5 h-5 bg-[#D4AF37] rounded-full shrink-0 mt-0.5 flex items-center justify-center">
      ...
      <section className="py-16 bg-[#D4AF37] text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/about/team" className="bg-white text-[#D4AF37] font-bold px-8 py-3 rounded-lg hover:bg-white/90 transition-colors">Meet the Team</Link>
