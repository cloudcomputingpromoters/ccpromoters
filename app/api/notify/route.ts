  ...
  registration: (data: Record<string, string>) => ({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        <div style="background:#1A3A8F;padding:24px;border-radius:8px 8px 0 0">
        ...
        <div style="background:#f7f9fc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0">
          ...
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0;color:#718096;width:140px"><strong>Name</strong></td><td style="color:#1A3A8F">${data.name}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Email</strong></td><td style="color:#1A3A8F">${data.email}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Discipline</strong></td><td style="color:#1A3A8F">${data.discipline || '—'}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Experience</strong></td><td style="color:#1A3A8F">${data.experience || '—'}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Location</strong></td><td style="color:#1A3A8F">${data.location || '—'}</td></tr>
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="background:#f7f9fc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0">
          ...
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0;color:#718096;width:140px"><strong>Name</strong></td><td style="color:#1A3A8F">${data.name}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Email</strong></td><td style="color:#1A3A8F">${data.email}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>File</strong></td><td style="color:#1A3A8F">${data.fileName}</td></tr>
          </table>
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        <div style="background:#1A3A8F;padding:24px;border-radius:8px 8px 0 0">
          ...
          <p style="color:#D4AF37;margin:6px 0 0;font-size:14px">Someone is interested in working with CCPromoters</p>
        </div>
        <div style="background:#f7f9fc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0">
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0;color:#718096;width:140px"><strong>Name</strong></td><td style="color:#1A3A8F;font-weight:600">${data.name}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Email</strong></td><td><a href="mailto:${data.email}" style="color:#D4AF37">${data.email}</a></td></tr>
            ${data.phone ? `<tr><td style="padding:8px 0;color:#718096"><strong>Phone</strong></td><td style="color:#1A3A8F">${data.phone}</td></tr>` : ''}
            ${data.company ? `<tr><td style="padding:8px 0;color:#718096"><strong>Company</strong></td><td style="color:#1A3A8F">${data.company}</td></tr>` : ''}
            <tr><td style="padding:8px 0;color:#718096"><strong>Subject</strong></td><td style="color:#1A3A8F">${data.subject || '—'}</td></tr>
          </table>
          <div style="margin-top:16px;padding:16px;background:#fff;border-left:4px solid #D4AF37;border-radius:4px">
            <p style="color:#718096;font-size:12px;margin:0 0 8px;text-transform:uppercase;letter-spacing:1px">Message</p>
            <p style="color:#1A3A8F;margin:0;line-height:1.6">${data.message}</p>
          </div>
          <div style="margin-top:24px;padding-top:16px;border-top:1px solid #e2e8f0">
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        <div style="background:#1A3A8F;padding:24px;border-radius:8px 8px 0 0">
          ...
          <p style="color:#D4AF37;margin:6px 0 0;font-size:14px">A candidate has applied via CCPromoters</p>
        </div>
        <div style="background:#f7f9fc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0">
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0;color:#718096;width:140px"><strong>Name</strong></td><td style="color:#1A3A8F;font-weight:600">${data.candidateName}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Email</strong></td><td><a href="mailto:${data.candidateEmail}" style="color:#D4AF37">${data.candidateEmail}</a></td></tr>
            ${data.candidatePhone ? `<tr><td style="padding:8px 0;color:#718096"><strong>Phone</strong></td><td style="color:#1A3A8F">${data.candidatePhone}</td></tr>` : ''}
            <tr><td style="padding:8px 0;color:#718096"><strong>Position</strong></td><td style="color:#1A3A8F;font-weight:600">${data.jobTitle}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Discipline</strong></td><td style="color:#1A3A8F">${data.discipline || '—'}</td></tr>
            <tr><td style="padding:8px 0;color:#718096"><strong>Location</strong></td><td style="color:#1A3A8F">${data.location || '—'}</td></tr>
          </table>
          <div style="margin-top:20px;padding-top:16px;border-top:1px solid #e2e8f0;display:flex;gap:12px;flex-wrap:wrap">
            <a href="mailto:${data.candidateEmail}" style="background:#D4AF37;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:bold;display:inline-block">
