      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: 'Manrope, sans-serif' }}>
            The Numbers Behind Our <span className="text-[#CC1016]">Track Record</span>
          </h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map(stat => (
            <div key={stat.label} className="text-center">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#CC1016] mb-2" style={{ fontFamily: 'Manrope, sans-serif' }}>
