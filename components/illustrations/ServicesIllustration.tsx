export default function ServicesIllustration() {
  return (
    <svg viewBox="0 0 560 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" aria-hidden="true">
      ...
      <rect x="18" y="20" width="160" height="260" rx="8" fill="url(#si-card)" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.45"/>
      {/* Panel label */}
      <rect x="28" y="30" width="90" height="14" rx="7" fill="#CC1016" fillOpacity="0.15"/>
      <text x="73" y="41" textAnchor="middle" fill="#CC1016" fontSize="7.5" fontFamily="monospace" fontWeight="700" letterSpacing="0.5">FOR EMPLOYERS</text>
      ...
      <line x1="38" y1="115" x2="170" y2="115" stroke="#CC1016" strokeWidth="1.2" strokeOpacity="0.6"/>
      <circle cx="70"  cy="115" r="3" fill="none" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      <circle cx="130" cy="115" r="3" fill="none" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      {/* Window fills */}
      ...
      <line x1="145" y1="115" x2="175" y2="100" stroke="#CC1016" strokeWidth="0.5" strokeOpacity="0.4" strokeDasharray="3 2"/>
      <text x="140" y="98" fill="#CC1016" fontSize="6" fontFamily="monospace" fillOpacity="0.5">PE STAMPED</text>
      {/* Title */}
      ...
      <g transform="translate(178,150)">
        <line x1="0" y1="0" x2="24" y2="0" stroke="#CC1016" strokeWidth="1.5" strokeOpacity="0.6"/>
        <circle cx="8"  cy="0" r="2" fill="#CC1016" fillOpacity="0.5"/>
        <circle cx="16" cy="0" r="2" fill="#CC1016" fillOpacity="0.6"/>
        <polygon points="24,-4 32,0 24,4" fill="#CC1016" fillOpacity="0.7"/>
      </g>

      {/* ── PANEL 2: Bridge / Transportation (center, taller) ── x=204–356 */}
      <rect x="204" y="10" width="152" height="280" rx="8" fill="url(#si-card)" stroke="#CC1016" strokeWidth="1.2" strokeOpacity="0.65"/>
      {/* Center glow */}
      <rect x="204" y="10" width="152" height="280" rx="8" fill="#CC1016" fillOpacity="0.015" filter="url(#si-glow-sm)"/>
      <text x="280" y="38" textAnchor="middle" fill="#CC1016" fontSize="9" fontFamily="monospace" fontWeight="700" letterSpacing="0.5">SMART MATCH</text>
      <rect x="220" y="26" width="120" height="16" rx="8" fill="#CC1016" fillOpacity="0.1"/>
      ...
      {/* Left tower */}
      <rect x="256" y="130" width="8" height="80" rx="1" fill="none" stroke="#CC1016" strokeWidth="1.2" strokeOpacity="0.8"/>
      <rect x="250" y="148" width="20" height="5" rx="1" fill="none" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.6"/>
      {/* Right tower */}
      <rect x="296" y="130" width="8" height="80" rx="1" fill="none" stroke="#CC1016" strokeWidth="1.2" strokeOpacity="0.8"/>
      <rect x="290" y="148" width="20" height="5" rx="1" fill="none" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.6"/>
      {/* Tower top glows */}
      <circle cx="260" cy="132" r="5" fill="#CC1016" fillOpacity="0.6" filter="url(#si-glow-xs)"/>
      <circle cx="300" cy="132" r="5" fill="#CC1016" fillOpacity="0.6" filter="url(#si-glow-xs)"/>
      {/* Cable stays */}
      {[224,238,250].map(x=>(
        <line key={x} x1="260" y1="134" x2={x} y2="210" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      ))}
      {[270,282,296].map(x=>(
        <line key={x} x1="260" y1="134" x2={x} y2="210" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      ))}
      {[264,278,292].map(x=>(
        <line key={x} x1="300" y1="134" x2={x} y2="210" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      ))}
      {[310,324,338].map(x=>(
        <line key={x} x1="300" y1="134" x2={x} y2="210" stroke="#CC1016" strokeWidth="0.8" strokeOpacity="0.5"/>
      ))}
      ...
      {/* "AI MATCH" label */}
      <rect x="220" y="78" width="120" height="42" rx="4" fill="#0A1830" stroke="#CC1016" strokeWidth="0.6" strokeOpacity="0.5"/>
      <text x="280" y="96"  textAnchor="middle" fill="#CC1016" fontSize="8"  fontFamily="monospace" fillOpacity="0.8">CANDIDATE ⟷ ROLE</text>
      ...
      <g transform="translate(516,60)">
        ...
        <polygon points="0,-10 4,-2 0,0 -4,-2" fill="#CC1016" fillOpacity="0.8"/>
        <polygon points="0,0 4,-2 0,10 -4,-2" fill="#1E3A5A"/>
        <text x="0" y="-15" textAnchor="middle" fill="#CC1016" fontSize="8" fontFamily="monospace" fillOpacity="0.7">N</text>
      </g>
      {/* Scale bar */}
